...
FeatureParser.prototype.processString = function(content, relativePath) {
  ...
  var head = [
    ...
    this.getRunTestHelperImport(basePath),
    "",
...
FeatureParser.prototype.getRunTestHelperImport = function(basePath) {
  if (this.options.runTestHelper) {
    let file =  basePath + this.options.runTestHelper;
    return "import { runFeature, runScenario } from '" + file + "';";
  } else {
    return '';
  }
}
